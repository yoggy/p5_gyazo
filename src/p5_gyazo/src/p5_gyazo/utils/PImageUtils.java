...
public class PImageUtils {
	...
	public static byte [] toPngByteArray(PImage pimage) {
		if (pimage == null) return null;
		...
		try {
	        ...
	        iw.setOutput(ios);
	        iw.write(null, new IIOImage(buffered_image, null, null), null);		        
	        png_data = bos.toByteArray();
			...
			System.err.println("PImageUtils.toPngByteArray(): PNG encode failed...");
			e.printStackTrace();
		}
